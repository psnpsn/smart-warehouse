...
public class BadgeController {
    ...
    public BadgeController(final BadgeService service) {
	...
	@PutMapping("{id}")
	public Mono updateById(@PathVariable("id") final String id, @RequestBody final Badge emp) {
		return service.update(id, emp);
	}
	@PostMapping
	public Mono save(@RequestBody final Badge emp) {
